<template>
    ...
    <n-gi>
        <n-card content-style hoverable title="Louise配置项">
            <n-form>
                <n-form-item :label="config.info" v-for="config in specificConfig(0)" :key="config.config_id" >
    ...
    <n-gi>
        <n-card content-style hoverable title="BOT配置项">
            <n-form>
                <n-form-item :label="config.info" v-for="config in specificConfig(1)" :key="config.config_id">
                    <n-input v-model:value="config.config_value"></n-input>
                </n-form-item>
            </n-form>
        </n-card>
    ...
    <n-gi>
        <n-card hoverable title="API配置项">
            <n-form>
                <n-form-item :label="config.info" v-for="config in specificConfig(2)" :key="config.config_id">
                    <n-input v-model:value="config.config_value"></n-input>
                </n-form-item>
            </n-form>
        </n-card>
    ...
    <n-button @click="updateConfig" type="primary" style="margin-left: 0; width: 100px">修改</n-button>
